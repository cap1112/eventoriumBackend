...
<div class="bg-white shadow-lg rounded-lg p-6 h-[100%]">
    ...
    <div class="flex justify-between items-center">
        <p class="text-gray-600 mb-6">A list of all the events including their id, name and state.
        </p>
            ...
            <tbody>
                @foreach ($registeredEvents as $event)
                    <tr>
                        ...
                        <td class="py-2 px-4 border-t"><a href="{{ route('events.show', $event->id) }}"><img
